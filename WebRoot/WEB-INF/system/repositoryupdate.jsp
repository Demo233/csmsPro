...
<s:form name="idFormMain" id="idFormMain" method="post" action="ck_updateCk?id=%{#ck.id}" namespace="/ck" onsubmit="return false">
    	...
    	<td width="100%" colspan="0" rowspan="0" align="center" >
      	<table border="0" width="100%" id="table1" cellspacing="1"  cellpadding="2"  bgcolor="gray">
            ...
            <td class="textbar01" width="85%" colspan="1">
            	<s:textfield size="18" name="ck.num" value="%{#ck.num}" readonly="true"/>
            </td>
          </tr>

         <tr>        	          
		<td class="textbar81" width="15%">仓库名称&nbsp;<span style="color:#708090;">*</span></td>
		<td class="textbar01" width="85%">
			<s:textfield name="ck.name" size="18" value="%{#ck.name}"/>					
		</td>         		
         </tr>   


         <tr>        	          
		<td class="textbar81" width="15%">联系人&nbsp;<span style="color:#708090;">*</span></td>
		<td class="textbar01" width="85%">
			<s:textfield name="ck.lxr" size="18" value="%{#ck.lxr}"/>					
		</td>         		
         </tr>  

	            <tr>        	          
		<td class="textbar81" width="15%">联系电话&nbsp;<span style="color:#708090;">*</span></td>
		<td class="textbar01" width="85%">
			<s:textfield name="ck.dh" size="18" value="%{#ck.dh}"/>					
		</td>         		
         </tr>  
         
             <tr>        	          
		<td class="textbar81" width="15%">仓储量&nbsp;<span style="color:#708090;">*</span></td>
		<td class="textbar01" width="85%">
			<s:textfield name="ck.kcl" size="18" value="%{#ck.kcl}"/>					
		</td>         		
         </tr>       	   	
        </table>
