...
function save()
{
	idFrmMain.action = "${pageContext.request.contextPath}/user/user_updateUser?id=" + ${sessionScope.user.id };
	idFrmMain.submit();
}
...
<table border="0" width="100%" id="table1" cellspacing="1"  cellpadding="2"  bgcolor="gray">
    ...
    <td class="textbar01" width="85%" colspan="1">
    	<input name="user.userLogin" value="${sessionScope.user.userLogin }" size="20" readonly="readonly">
    </td>
  </tr>          
  <tr>
  	<td class="textbar81" width="15%" colspan="1">用户姓名</td>
    <td class="textbar01" width="85%" colspan="1"><input name="user.userName" value="${sessionScope.user.userName }" size="20"></td>
  </tr>          
	<tr>
  	<td class="textbar81" width="15%" colspan="1">用户密码&nbsp;<span style="color:#708090;">*</span></td>
    <td class="textbar01" width="85%" colspan="1"><input type="password" name="user.userPwd" value="${sessionScope.user.userPwd }" size="21"></td>
  </tr>      
	<tr>
  	<td class="textbar81" width="15%" colspan="1">用户简介</td>
    <td class="textbar01" width="85%" colspan="1"><textarea name="user.note"  style="width:352px">${sessionScope.user.note }</textarea>
     </td>
  </tr>  
