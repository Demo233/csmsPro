...
<tr>
    <td class="textbar81" width="15%">单据号${rkd.rkdNum }</td>
		<td class="textbar01" width="35%">
      <input name="rkd.rkdNum" type="text" value="${Num }" readonly size="20">
    </td>
    <td class="textbar81" width="15%">办理人</td>
		<td class="textbar01" width="35%">
			<input type="text" name="rkd.rkdBly"  value="${rkd.rkdBly }"/>
...
<tr>
    ...
    <td class="textbar81" width="15%">来源</td>
		<td class="textbar01"  width="35%">
      <input type="text" name="rkd.rkdLy" value="${rkd.rkdLy }" size="20">
    </td>      
</tr>
<tr>
    <td class="textbar81" width="15%">备注</td>
		<td class="textbar01"  width="85%" colspan="3">
      <textarea id="tare1" name="rkd.rkdNote" cols="80" rows="4" >${rkd.rkdNote }</textarea>
    </td>        
</tr>
